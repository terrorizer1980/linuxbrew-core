class Knot < Formula
  ...
  url "https://secure.nic.cz/files/knot-dns/knot-3.0.8.tar.xz"
  ...
  bottle do
    ...
    sha256 x86_64_linux:  "2b4543a53f039d6f5e9c78974649171ab075edcbfb93088397694281229480b3" # linuxbrew-core
  end
