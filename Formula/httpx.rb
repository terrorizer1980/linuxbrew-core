class Httpx < Formula
  ...
  url "https://github.com/projectdiscovery/httpx/archive/v1.1.1.tar.gz"
  sha256 "487bed3400d9c45c565d96de8f02cea89877810d848d430676dd729f6f9add18"
  license "MIT"
  ...
  bottle do
    ...
    sha256 cellar: :any_skip_relocation, x86_64_linux:  "102d35b81a64b1376999d107393093993212cbbf314e3bc1c2a90ee063af7d8b" # linuxbrew-core
  end
