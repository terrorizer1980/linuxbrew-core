class Clair < Formula
  ...
  url "https://github.com/quay/clair/archive/v4.2.0.tar.gz"
  sha256 "3a514a6e54370b78cbde0b29501586456f0d68395e460992b890849a0442077d"
  license "Apache-2.0"
  ...
  bottle do
    ...
    sha256 cellar: :any_skip_relocation, x86_64_linux: "267f82d7ed77b95c30b4d22e0a9ffdc85ea27ba631cd7fd349da98b5d9357760" # linuxbrew-core
  end
