class Janet < Formula
  ...
  url "https://github.com/janet-lang/janet/archive/v1.17.1.tar.gz"
  sha256 "c9357192c4d0d24f08a02aecd14df9dc52174696334e4a2576c0252c27866cb7"
  license "MIT"
  ...
  bottle do
    ...
    sha256 cellar: :any_skip_relocation, x86_64_linux:  "0ed1228aea077a01805e1aff7f0b61243e17a44fd73b2a6b19733320107f5a1d" # linuxbrew-core
  end
