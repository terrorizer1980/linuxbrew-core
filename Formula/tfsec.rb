class Tfsec < Formula
  ...
  url "https://github.com/aquasecurity/tfsec/archive/v0.52.1.tar.gz"
  ...
  bottle do
    ...
    sha256 cellar: :any_skip_relocation, x86_64_linux:  "41bf6ecc6043a801888de63f19fc35b2e6a18a57cd556089274ea9070dc3d21e" # linuxbrew-core
  end
